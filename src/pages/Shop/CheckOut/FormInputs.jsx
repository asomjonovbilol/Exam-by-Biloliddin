...
const FormInputs = () => {
  return (
    <div className="left mt-9 ">
      ...
      <form>
        <div className="w-[750px] grid grid-cols-2 gap-x-8 gap-y-4">
          ...
          <div>
            ...
            <div className="block">
              ...
              <textarea
                className="resize-none p-3 border border-gray-300 w-full focus:border-blue-500 focus:outline-none focus:ring-blue-200 focus:ring-2 duration-200 rounded-md"
                name="text"
                id="text"
                cols="40"
                rows="5"
